...
// Decrypt file
const decryptFile = (file, key, iv, encoding) => {
  ...
  writeFileSync(file, decrypted, { encoding });
};
...
const decryptFileCCM = (file, key, iv, tag, options) => {
  const { aad, encoding } = Object.assign(
    {
      aad: null,
      encoding: 'utf-8',
    },
